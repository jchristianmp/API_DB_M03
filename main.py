...
items = Table("car_price_predictions", metadata, autoload_with=engine)
...
def publicar(file: UploadFile = File(...)):
    ...
    try:
        ...
        ruta_modelo = os.path.join(ruta_actual, "precio_coches_pipeline.joblib")  # Actualización de la ruta
        ...
        df_concatenado.to_sql('car_price_predictions', con=engine, if_exists='append',index=False)
